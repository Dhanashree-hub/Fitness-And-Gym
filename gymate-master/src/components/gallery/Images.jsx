const imgStyles = `relative transition-all duration-300 after:absolute after:bottom-1/2 after:right-1/2 after:z-10 after:h-[80%] after:w-[80%] after:translate-x-1/2 after:translate-y-1/2 after:bg-yellow-500 after:bg-opacity-0 after:transition-all after:duration-300 hover:scale-110 hover:after:bg-opacity-50 h-full w-full bg-cover bg-center`;
