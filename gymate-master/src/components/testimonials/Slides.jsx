const slides = [
  {
    quote:
      "I've been a member of Gold's Gym for the past 6 months and it has been an amazing experience. The trainers are knowledgeable and supportive, the equipment is top-notch, and the community of members is friendly and encouraging.",
    name: "James Anderson",
    desc: "Sportsman",
  },
  {
    quote:
      "Amazing staff.!!!Hygiene is always a priority here.There are lockers to keep our bags.The personal trainers are extremely helpful.",
    name: "Ketty Mario",
    desc: "Body Builder",
  },
  {
