const btnStyles = `self-start font-medium transition-all hover:text-yellow-500`;
...
before:absolute before:bottom-0 before:h-1 before:w-16 before:bg-yellow-500"
      >
        Categories
      </h3>
