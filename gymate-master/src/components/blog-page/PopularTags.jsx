const btnStyles = `bg-white px-1.5 py-1 font-medium transition-all hover:bg-yellow-500 hover:text-white`;
...
text-xl font-bold before:absolute before:bottom-0 before:h-1 before:w-16 before:bg-yellow-500"
      >
        Popular Tags
      </h3>
