...
const linkStyles = `inline-block bg-yellow-500 px-4 py-2 text-xs font-bold uppercase text-black`;
      ...
      <div className="perspective group h-72 xl:col-span-2 xl:w-1/2 xl:justify-self-center 3xl:col-span-1 3xl:w-full">
        <div className={`${cardStyles} group-hover:rotate-y-180`}>
          ...
          <div className={frontStyles.card}>
            ...
            <p className="text-sm font-medium text-gray-300">
            Creating content, Participating in events, Engaging with followers on social media, and Providing feedback to the brand
            </p>
            <Link to="/Blog" className={linkStyles}>
              Read more &rarr;
            </Link>
